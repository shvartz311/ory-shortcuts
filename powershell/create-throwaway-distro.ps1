...
$download="C:\Users\jdnovick\Downloads\Ubuntu_2004.2020.424.0_x64"
...
New-Item -Path C:\Users\jdnovick\AppData\Local\Packages\Throwaway_WSL_Ubuntu -ItemType Directory -Force
...
wsl.exe -d ubuntu-throwaway-2004 bash -c "adduser --gecos '' --ingroup sudo jdnovick"
Get-ItemProperty Registry::HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Lxss\*\ DistributionName | Where-Object -Property DistributionName -eq ubuntu-throwaway-2004 | Set-ItemProperty -Name DefaultUid -Value ((wsl -d ubuntu-throwaway-2004 -u jdnovick -e id -u) | Out-String)
